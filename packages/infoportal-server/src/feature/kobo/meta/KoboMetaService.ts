...
export class KoboMetaMapper {
  ...
  static readonly mappersCreate: Record<Kobo.FormId, MetaMapperInsert> = {
    ...
    [KoboIndex.byName('ecrec_small_scale').id]: KoboMetaMapperEcrec.ecrecSmallScale,
    [KoboIndex.byName('ecrec_subsistance').id]: KoboMetaMapperEcrec.ecrecSubsistance,
    ...
    [KoboIndex.byName('protection_ipaTracker').id]: KoboMetaMapperProtection.ipaTracker,
    ...
    [KoboIndex.byName('shelter_commonSpaces').id]: KoboMetaMapperShelter.createCommonSpaces,
