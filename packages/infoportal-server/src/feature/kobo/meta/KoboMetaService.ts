...
export class KoboMetaMapper {
  ...
  static readonly mappersCreate: Record<Kobo.FormId, MetaMapperInsert> = {
    ...
    [KoboIndex.byName('ecrec_small_scale').id]: KoboMetaMapperEcrec.ecrec_small_scale,
    [KoboIndex.byName('ecrec_subsistance').id]: KoboMetaMapperEcrec.ecrec_subsistance,
