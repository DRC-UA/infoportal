export namespace AiTypeGeneralProtection {
  ...
  export const map = (a: Type) => ({
    ...
    ctn2ej8lqf3085j4w:
      a['Plan/Project Code'] === undefined
        ? undefined
        : 'cuar8eplqf1xm9225' + ':' + options['Plan/Project Code'][a['Plan/Project Code']!],
    c6bulw2lqf3085j4y:
  ...
  export const mapSub = (a: TypeSub) => ({
    ...
    cpzldoslw6fmn973: a['HNRP Scope'] === undefined ? undefined : optionsSub['HNRP Scope'][a['HNRP Scope']!],
    cfjmcc9lw6fyn0w4:
  ...
  export const optionsSub = {
    ...
    Indicators: {
      ...
      '# of individuals in a community trained on protection approaches or issues (not including GBV or Child Protection)':
        'c4gngpdlqmgu66u1h',
      '# of individuals supported through community-based organizations with social rehabilitation':
        'cigruiclqmgu66u1i',
      '# of organizations of people with disabilities (OPDs) supported to provide social rehabilitation':
        'cr9kr8qlqmgu66v1j',
      '# of hotlines established and operated': 'chkpac2lqmgu66v1k',
      '# of calls received by hotlines from individuals': 'cevyso1lqmgu66v1l',
      '# of individuals with specific needs who received cash assistance to prevent, mitigate or respond to protection risks':
        'cxnbfd8lqmgu66v1m',
      '# of individuals with specific needs who received in-kind protection assistance to prevent, mitigate or respond to protection risks':
        'cbolgy6lqmgu66v1n',
