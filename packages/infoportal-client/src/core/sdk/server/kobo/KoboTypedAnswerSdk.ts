...
export class KoboTypedAnswerSdk {
  ...
  private readonly buildSearch = (request: 'searchByAccess' | 'search') => {
    ...
    return {
      ...
      ...make('conflict_trainings', (filters?: KoboAnswerFilter) =>
        req({
      ...
      ...make('meal_pssPdm', (filters?: KoboAnswerFilter) =>
        req({
      ...
      ...make('meal_kiiCbpPam', (filters?: KoboAnswerFilter) =>
        req({
          formId: KoboIndex.byName('meal_kiiCbpPam').id,
          fnMapKobo: Meal_kiiCbpPam.map,
          ...filters,
        }),
      ),
      ...make('gbv_cs_pdm', (filters?: KoboAnswerFilter) =>
        req({
      ...
      ...make('protection_pss', (filters?: KoboAnswerFilter) =>
        req({
