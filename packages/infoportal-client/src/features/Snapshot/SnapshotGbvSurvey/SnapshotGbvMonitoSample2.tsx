            ...
            <SlidePanel>
              ...
              <Div>
                <ChartPieWidgetBy
                  ...
                  dense
                  data={data}
                  filter={(_) => _.preferred_modality_training === 'ongoing'}
                />
                <ChartPieWidgetBy
                  sx={{flex: 1}}
                  title="Once off block"
                  dense
                  data={data}
                  filter={(_) => _.preferred_modality_training === 'once_block'}
                />
              </Div>
            </SlidePanel>
            <SlidePanel>
              <ChartPieWidgetBy
                ...
                data={data}
                filter={(_) =>
                  _.consider_mental_health === 'necessary' || _.consider_mental_health === 'very_necessary'
                }
              />
            </SlidePanel>
            <SlidePanel>
