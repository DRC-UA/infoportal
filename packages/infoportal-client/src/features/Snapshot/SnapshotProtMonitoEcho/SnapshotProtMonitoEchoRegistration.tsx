        ...
        <Div>
          <Div column>
            <SlideTxt>
              ...
              Accessing government compensation for damaged or destroyed property remains significantly hindered by
              bureaucratic obstacles and complex procedures. Residents in remote areas often need to travel long
              distances to obtain or renew essential documentation, with limited public transport options and high
              private transportation costs posing substantial barriers. IDPs face additional challenges, particularly in
              formalizing inheritance and ownership documents, further complicating their access to compensation.
            </SlideTxt>
            <SlidePanel>
              ...
              <Div>
                <Lazy
                  ...
                  fn={(d) =>
                    ChartHelper.percentage({
                      ...
                      value: (_) =>
                        _.isIdpRegistered !== 'yes' && _.are_you_and_your_hh_members_registered_as_idps !== 'yes_all',
                    })
                  }
                >
                  {(d, l) => (
                ...
                <Lazy
                  ...
                  fn={(d) =>
                    ChartHelper.percentage({
                      data: getIdpsAnsweringRegistrationQuestion(d).filter(
                        (_) => _.age && _.age >= 18 && _.age <= 60 && _.gender && _.gender === Person.Gender.Male,
                      ),
                      value: (_) =>
                        _.isIdpRegistered !== 'yes' && _.are_you_and_your_hh_members_registered_as_idps !== 'yes_all',
                    })
            ...
            <SlidePanel>
              ...
              <ChartBarMultipleBy
                data={ctx.dataFiltered}
                by={(_) =>
                  _.have_you_experienced_any_barriers_in_obtaining_or_accessing_identity_documentation_and_or_hlp_documentation
                }
                label={
              ...
              <ChartBarMultipleBy
                ...
                label={{
                  ...
                  cost_estimation_certificate_state_commission_issued_when_personal_request_is_made:
                    'Cost estimation certificate - state commission',
