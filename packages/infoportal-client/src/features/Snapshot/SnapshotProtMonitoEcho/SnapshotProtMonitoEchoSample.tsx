      ...
      <PdfSlideBody>
        <Div>
          <Div column sx={{flex: 4}}>
            <SlideTxt>
              This snapshot summarizes the findings of <b>protection monitoring</b>&nbsp; implemented through household
              surveys in the following oblasts:
              <ul style={{columns: 2}}>
            ...
            <SlideTxt sx={{mb: 2}}>
              DRC protection monitoring targeted internally displaced persons (IDPs) and people directly exposed to and
              affected by the current armed conflict in order to understand the protection needs facing affected
              populations; informing DRC and the protection communities' response.
            </SlideTxt>
