          ...
          <Div column>
            <SlideTxt>
              <Lazy
                ...
                fn={() => {
                  return {
                    ...
                    healthPnCount: ctx.dataFiltered.filter(
                      (_) =>
              ...
              >
                {(_) => (
                  <p>
                    Many men avoid seeking healthcare due to fears of conscription near hospitals, risking serious
                    health issues. The cancellation of IDP allowances has further limited access to healthcare, leaving
                    many unable to afford rising costs. This financial strain forces families to cut back on medical
                    expenses and reduce food consumption.
                  </p>
                )}
              </Lazy>
            </SlideTxt>
            <SlidePanel>
              <ChartPieWidgetBy
                ...
                filterBase={(_) =>
                  _.do_you_have_access_to_health_care_in_your_current_location !== 'unable_unwilling_to_answer'
                }
                data={ctx.dataFiltered}
              />
              <ChartBarMultipleBy
            ...
            <SlidePanel>
              <ChartPieWidgetBy
                ...
                filterBase={(_) =>
                  _.do_you_or_anyone_in_your_household_have_a_disability_status_from_the_gov !==
              ...
              <ChartBarSingleBy
                ...
                label={{
                  ...
                  status_registration_rejected_not_meeting_the_criteria_as_per_ukrainian_procedure:
                    'Status registration or renewal rejected',
                }}
                mergeOptions={{
