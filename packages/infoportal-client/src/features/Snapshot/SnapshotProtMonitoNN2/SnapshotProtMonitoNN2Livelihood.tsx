          ...
          <Div column>
            <SlideTxt>
              ...
              >
                {(_) => (
                  <p>
                    The primary reasons for unemployment remain unchanged from previous reports, with a shortage of job
                    opportunities identified as the key factor. To address gaps in meeting basic needs, individuals are
                    resorting to depending on external support, cutting back on expenses related to food and healthcare
                    and depleting savings, a situation that may be exacerbated by Resolution 332 introducing changes in
                    payment of IDP benefits.
                  </p>
                )}
              </Lazy>
            </SlideTxt>
