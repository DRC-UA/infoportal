      ...
      <PdfSlideBody>
        <Div>
          <Div column sx={{flex: 3.6}}>
            <SlideTxt>
              This snapshot summarizes the findings of protection monitoring implemented through household surveys in
              Mykolaiv Oblast between February and March 2024. DRC protection monitoring targeted internally displaced
              persons (IDPs) and people directly exposed to and affected by the current armed conflict in order to
              understand the protection needs facing affected populations and inform both DRC's interventions and the
              broader humanitarian response efforts.
            </SlideTxt>
            ...
            <Div>
              ...
              <Div column>
                <SlidePanel>
                  ...
                  <ChartBarStacker
                    data={ctx.ageGroup(ctx.dataFiltered, Person.ageGroup['DRC'], true)}
                    height={250}
                    colors={(t) => [snapshotAlternateColor(t), t.palette.primary.main]}
                  />
                </SlidePanel>
                <SlidePanel>
