...
export const useCustomHeader = (): undefined | ((_: HeaderParams<any>) => ReactNode) => {
  ...
  return useMemo(() => {
    switch (ctx.form.id) {
      case KoboIndex.byName('awareness_raising_partners').id:
      ...
      case KoboIndex.byName('legal_individual_aid_partners').id:
      case KoboIndex.byName('mistosyly_winterization_uhf_2025_2026').id:
