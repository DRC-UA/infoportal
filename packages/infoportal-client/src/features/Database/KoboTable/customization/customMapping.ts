...
export const databaseCustomMapping: Record<any, (_: any) => any> = {
  ...
  [KoboIndex.byName('legal_individual_aid_partners').id]: (_) =>
    KoboXmlMapper.Breakdown.addProperty(_, KoboXmlMapper.Persons.legal_individual_aid_partners),
  [KoboIndex.byName('meal_cashPdm').id]: (_) => KoboXmlMapper.Breakdown.addProperty(_, KoboXmlMapper.Persons.cash_pdm),
  [KoboIndex.byName('mistosyly_winterization_uhf_2025_2026').id]: (_) =>
    KoboXmlMapper.Breakdown.addProperty(_, KoboXmlMapper.Persons.mistosyly_winterization_uhf_2025_2026),
  ...
  [KoboIndex.byName('protection_gbv').id]: (_) =>
    KoboXmlMapper.Breakdown.addProperty(_, KoboXmlMapper.Persons.protection_gbv),
  ...
  [KoboIndex.byName('protection_ipaTracker').id]: (_) =>
    KoboXmlMapper.Breakdown.addProperty(_, KoboXmlMapper.Persons.protection_ipaTracker),
  ...
  [KoboIndex.byName('shelter_modern_women').id]: (_) =>
    KoboXmlMapper.Breakdown.addProperty(_, KoboXmlMapper.Persons.shelter_modernWomen),
