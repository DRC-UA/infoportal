...
export const ProtectionDashboardMonitoViolence = () => {
  ...
  return (
    <Div responsive>
      <Div column>
        <Lazy
          deps={[ctx.dataFiltered, category]}
          fn={() => {
            ...
            return new ChartHelper({total, ...res})
              .setLabel({
                total: m.selectAll,
            ...
            <SlidePanel title={m.protHHS2.reportedIncidents}>
              <ChartBar
                ...
                labels={{
                  total: (
                    <Checkbox
                      indeterminate={!allChecked && oneChecked}
                      checked={allChecked}
                      onChange={() => {
                  ...
                  has_any_adult_male_member_experienced_violence: (
                    <Checkbox
                      ...
                      onChange={(e) =>
                        setCategory((prev) => ({
                          ...prev,
                          has_any_adult_male_member_experienced_violence: e.target.checked,
                        }))
                      }
                    />
                  ),
                  has_any_adult_female_member_experienced_violence: (
                    <Checkbox
                      ...
                      onChange={(e) =>
                        setCategory((prev) => ({
                          ...prev,
                          has_any_adult_female_member_experienced_violence: e.target.checked,
                        }))
                      }
                    />
                  ),
                  has_any_boy_member_experienced_violence: (
                    <Checkbox
                      ...
                      onChange={(e) =>
                        setCategory((prev) => ({...prev, has_any_boy_member_experienced_violence: e.target.checked}))
                      }
                    />
                  ),
                  has_any_girl_member_experienced_violence: (
                    <Checkbox
                      ...
                      onChange={(e) =>
                        setCategory((prev) => ({...prev, has_any_girl_member_experienced_violence: e.target.checked}))
                      }
                    />
                  ),
                  has_any_other_member_experienced_violence: (
                    <Checkbox
                      ...
                      onChange={(e) =>
                        setCategory((prev) => ({...prev, has_any_other_member_experienced_violence: e.target.checked}))
                      }
                    />
                  ),
                }}
      ...
      <Div column>
        <Lazy
          deps={[groupedIndividualsType.type]}
          fn={() =>
        ...
        <Lazy
          deps={[groupedIndividualsType.when]}
          fn={() =>
            ChartHelper.multiple({
              ...
              .setLabel(
                Protection_hhs3.options.when_did_the_incidents_occur_has_any_adult_male_member_experienced_violence,
              )
              .sortBy.value()
              .get()
          }
