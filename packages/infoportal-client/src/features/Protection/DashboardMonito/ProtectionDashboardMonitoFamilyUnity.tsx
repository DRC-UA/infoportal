...
type Filters = Pick<
  Record<keyof (typeof Protection_hhs3.options)['are_you_separated_from_any_of_your_households_members'], boolean>,
  'partner' | 'child_lt_18' | 'child_gte_18' | 'mother' | 'father' | 'caregiver' | 'other_relative'
>
            ...
            <Lazy
              ...
              fn={() =>
                ChartHelper.single({
                  ...
                  .setLabel(Protection_hhs3.options.where_is_your_partner)
                  .get()
              }
            >
              {(_) => <ChartBar data={_} />}
            ...
            <Lazy
              ...
              fn={() =>
                ChartHelper.single({
                  ...
                  .setLabel(Protection_hhs3.options.where_is_your_partner_remain_behind_in_the_area_of_origin)
                  .get()
              }
            >
              {(_) => <ChartBar data={_} />}
