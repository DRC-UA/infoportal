      ...
      <Div column>
        <SlidePanel>
          ...
          <ChartBarMultipleByKey
            ...
            label={{
              ...
              wg_using_your_usual_language_have_difficulty_communicating:
                m.protHHS2.wg_using_your_usual_language_have_difficulty_communicating,
              '': m.none,
            }}
        ...
        <SlidePanel>
          ...
          <ChartBarSingleBy
            ...
            label={Protection_hhs3.options.why_dont_they_have_status}
          />
        </SlidePanel>
      </Div>
      <Div column>
