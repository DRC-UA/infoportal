export namespace AiGbvType {type Opt<T extends keyof typeof options> = keyof (typeof options)[T]
  ...
  export const mapSub = (a: TypeSub) => ({
    ...
    'cqb6zihlz6vk00d3': a['Type of distribution'] === undefined ? undefined : optionsSub['Type of distribution'][a['Type of distribution']!],
    'c5618bdlz6voilh7': a['Who distributed the kits?'] === undefined ? undefined : optionsSub['Who distributed the kits?'][a['Who distributed the kits?']!],
    'cs7s2k4lz9rrvoq3': a['Dignity kits in stock?'] === undefined ? undefined : optionsSub['Dignity kits in stock?'][a['Dignity kits in stock?']!],
    ...
    'cnf5ivglz9sg86uk': a['Any assessment/feedback done/collected on post distribution of kits?'] === undefined ? undefined : optionsSub['Any assessment/feedback done/collected on post distribution of kits?'][a['Any assessment/feedback done/collected on post distribution of kits?']!],
    ...
    'c1167nvlw6fybtr4': a['Outside HNRP Scope sub-categories'] === undefined ? undefined : 'cs4astklw6ftd2y2' + ':' + optionsSub['Outside HNRP Scope sub-categories'][a['Outside HNRP Scope sub-categories']!]
  })
