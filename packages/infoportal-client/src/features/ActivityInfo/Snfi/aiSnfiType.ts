export namespace AiSnfiType {
  ...
  export const options = {
    ...
    'Indicators - SNFI': {
      ...
      '# of individuals supported with light humanitarian repairs - Cash': 'coe5n5slrke6zead',
      '# of individuals supported with light humanitarian repairs - In Kind': 'cv42tfvlrke6zeae',
      '# of individuals supported with light humanitarian repairs - Voucher': 'ccagmwilrke6zebw',

      '# of individuals supported with medium humanitarian repairs - Cash': 'cjtu8tjlrke6zeaf',
      '# of individuals supported with medium humanitarian repairs - In Kind': 'c874hhclrke6zeag',
      ...
      '# of individuals supported with heavy humanitarian repairs - Cash': 'cu7r3xtlrke6zebn',
      '# of individuals supported with heavy humanitarian repairs - In Kind': 'clah6j5lrke6zebo',
