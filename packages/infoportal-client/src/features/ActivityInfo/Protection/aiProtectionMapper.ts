                      ...
                      ai: {
                        Indicators: fnSwitch(
                          activity,
                          {
                            ...
                            [DrcProgram.FGD]:
                              '# of interviews conducted with key informants through community level protection monitoring',
                            [DrcProgram.PGS]:
                              '# of individuals who received individual or group-based psychosocial support',
                            [DrcProgram.MHPSSActivities]:
                              '# of individuals who received individual or group-based psychosocial support',
                            [DrcProgram.ProtectionMonitoring]:
                              '# of individuals reached through protection monitoring at the household level',
                            [DrcProgram.CommunityLevelPm]:
                              '# of interviews conducted with key informants through community level protection monitoring',
                            [DrcProgram.AwarenessRaisingSession]:
                              '# of individuals who participated in awareness raising activities on Protection',
                            [DrcProgram.Referral]:
                              '# of individuals with specific needs referred to specialized services and assistance',
                          },
                        ...
                        ...fnSwitch<DrcProgram, Partial<AiProtectionType.TypeSub>>(
                          activity,
                          {
                            [DrcProgram.FGD]: {
                ...
                return subActivities.flatMap((s) => {
                  return {
                    submit: checkAiValid(
                      ...
                      ai.Hromada,
                      ai.Settlement,
                      ai['Plan/Project Code'],
                      ...subActivities.map((_) => _.ai.Indicators),
                    ),
