...
export namespace AiTypeChildProtectionAorRmm {
    ...
    return [
      {
        ...
        fields: {
          ...
          c4y1cm9m4wi4r8x7: a['Implementing Partner 2']
            ...
            : undefined,
          cx026u6m52jrfo27: a['Plan/Project Code']
            ? 'cqkzhlom4tt5ng81aml' +
              ':' +
              options['Activity Planning Module (Child Protection)'][a['Plan/Project Code']!]
            : undefined,
  ...
  export const options = {
    ...
    'Activity Planning Module (Child Protection)': {
      'CP-DRC-00001': 'ci9xc7tm99yyvrx2',
      'CP-DRC-00002': 'cosm9km99z0r7d3',
      'CP-DRC-00003': 'cva3v3zm99z25464',
      'CP-DRC-00004': 'ckjm906m99z3u3h5',
    },
  }
      ...
      return [
        {
          ...
          fields: {
            ...
            cikc6sim8crtlw34: a['Outside HNRP Scope categories']
    ...
    export const options = {
      'Indicators - Protection': {
        ...
        'Provision of mental health and psychosocial support (MHPSS) services to parents/caregivers (Individual and group) and positive parenting sessions > # of parents/caregivers who receive psychosocial support and/or positive parenting leading to improved relationships with the children under their care':
          'cuv6r6tm5111jhc4',
        'Child protection case management > # of identified at risk girls and boys who receive case management services that meet their unique needs':
          'cfbszlcm5111jhc5',
        'Service for children affected by, or at-risk victims of, explosive ordnance (EO)/victim assistance > # of children and caregivers who have been affected by landmine or other explosive weapons received by prevention and/or survivor assistance interventions':
          'c2kxk5om5111jhc6',
        'Child protection/child friendly legal assistance > # of girls and boys and their caregivers who received legal assistance on CP issues':
          'cwulrv2m5111jhc7',
        'Referral to specialised services to address the critical needs of children and caregivers > # of girls and boys, caregivers with specific needs referred to specialized services and assistance (Health, rehabilitation, MH, and MPCA etc)':
          'cq4smtbm5111jhc8',
        'Family tracing and reunification > # of girls and boys reunified with their primary or extended family':
          'cshp7mkm5111jhc9',
        'Supporting unaccompanied children or children at risk in alternative family-based care > # of girls and boys supported with family based alternative care arrangements':
          'cqf397im5111jhca',
        'Emergency case management fund > # of children and their family members who received C4P, or emergency case management funds (in cash) utilised in standard case management service provision to prevent, mitigate, or respond to child protection risks':
          'c1zm1tvm5111jhcb',
        'Emergency support for children and caregivers (in-kind/NFI) > # of children and caregivers who received protection and social assistance in-kind':
          'cqfppgvm5111jhcc',
        ...
        'Mainstreaming child protection in other sectors > # of women and men non-child protection staff trained on child protection mainstreaming CP approaches, safe identification, and referral pathways, etc':
          'cpmjx4lm5111jhch',
        'Strengthen the child safeguarding and PSEA measures in humanitarian response > # of CP partners staff (UN/INGOs/NGOs) trained on PSEA and child safeguarding':
          'cmlkajxm5111jhci',
        'Strengthen the child safeguarding and PSEA measures in humanitarian response > # of girls, boys, women, and men aware of the ways to report safeguarding issues, including possible PSEA allegations':
          'cvl1ycym5111jhcj',
        'Unaccompanied and separated children > # of unaccompanied girls and boys identified and documented':
          'csp8v1em5111jhck',
        'Unaccompanied and separated children > # of separated girls and boys identified and documented':
          'ct6vg73m5111jhcl',
        'Establishment of CFS > # of CP safe space including child friendly spaces, Community Resilience Centres (CRC), and other safe spaces, service points (centre) established this month':
          'ctnp632m5111jhcm',
        'Establishment of mobile team > # of mobile team established and functional this month (mobile groups)':
          'cnf3ewm5111jhcn',
      },
