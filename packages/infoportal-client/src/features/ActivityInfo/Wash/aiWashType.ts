export namespace AiWashType {
  ...
  export const map = (a: Type) => ({
    ...
    c11ns3tlqc9s1a4n: a['Oblast'] === undefined ? undefined : 'cemuxawlq3kfmqf2' + ':' + a['Oblast'],
    cq3a2vllqc9tar9o: a['Raion'] === undefined ? undefined : 'cd5q9sdlq3kklo314' + ':' + a['Raion'],
    cpzpk2blqc9v5gcp: a['Hromada'] === undefined ? undefined : 'cwlaxxlq3kp2bu5a' + ':' + a['Hromada'],
    cbdwyrqlqc9wodaq: a['Settlement'] === undefined ? undefined : 'cfn5ltdlq3lbcb95w' + ':' + a['Settlement'],
  ...
  export const options = {
    'Activity Plan Code': {
      'WASH-DRC-00001': 'cn94ssyltn670dk3',
