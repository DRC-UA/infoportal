...
export enum DrcProgram {
  ...
  IPA = 'IPA [general]',
  IPAForElderly = 'IPA [for elderly]',
  IPAC4P = 'IPA [C4P referred from UCT]',
  Legal = 'Legal',
  LegalAid = 'LegalAid',
  ...
  MHPSSActivities = 'MHPSS Activities',
  MPCA = 'MPCA',
  MSME = 'MSME',
  NFI = 'NFI',
  ...
  PIS = 'Psychosocial Individual Session',
  PSO = 'PSS: Other',
  PSS = 'PSS',
  ...
  SectoralCashForAnimalFeed = 'Sectoral Cash For AnimalFeed',
  SectoralCashForAnimalShelterRepair = 'Sectoral Cash For Animal Shelter Repair',
  SectoralCashMixed = 'Sectoral Cash (Mixed)',
...
export class DrcSectorHelper {
  private static readonly byProgram: Record<DrcProgram, DrcSector[]> = {
    ...
    [DrcProgram.MHPSSActivities]: [DrcSector.PSS],
    MPCA: [DrcSector.MPCA],
    MSME: [DrcSector.Livelihoods],
    NFI: [DrcSector.NFI],
    Observation: [DrcSector.GeneralProtection],
    PSS: [DrcSector.GeneralProtection],
    [DrcProgram.P2P]: [DrcSector.PSS],
    [DrcProgram.ProtectionAccompaniment]: [DrcSector.GeneralProtection],
    [DrcProgram.ProtectionMonitoring]: [DrcSector.GeneralProtection],
    [DrcProgram.PSO]: [DrcSector.PSS],
    [DrcProgram.PFA]: [DrcSector.PSS],
    [DrcProgram.PGS]: [DrcSector.PSS],
    [DrcProgram.PIS]: [DrcSector.PSS],
    Referral: [DrcSector.GeneralProtection],
    [DrcProgram.RSA]: [DrcSector.PSS],
    [DrcProgram.SectoralCashForAgriculture]: [DrcSector.Livelihoods],
    [DrcProgram.SectoralCashForAnimalFeed]: [DrcSector.Livelihoods],
    [DrcProgram.SectoralCashForAnimalShelterRepair]: [DrcSector.Livelihoods],
    [DrcProgram.SectoralCashMixed]: [DrcSector.Livelihoods],
...
export enum DrcProject {
  ...
  'UKR-000306 DUTCH' = 'UKR-000306 Dutch II',
  ...
  'UKR-000419 DANIDA' = 'UKR-000419 DANIDA',
  'UKR-000420 HGBF' = 'UKR-000420 HGBF',
  ...
  'UKR-000441 UHF11' = 'UKR-000441 UHF11',
  'UKR-000457 DMFA' = 'UKR-000457 DMFA',
