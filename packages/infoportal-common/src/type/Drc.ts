...
export enum DrcProgram {
  ...
  LegalAssistanceDocs = 'Legal Assistance: with docs',
  LegalAssistanceOther = 'Legal Assistance: other',
...
export class DrcSectorHelper {
  private static readonly byProgram: Record<DrcProgram, DrcSector[]> = {
    ...
    [DrcProgram.LegalAssistanceDocs]: [DrcSector.Legal],
    [DrcProgram.LegalAssistanceOther]: [DrcSector.Legal],
