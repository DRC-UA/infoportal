...
const koboIndex = {
  awareness_raising_feedback: 'aGykmownZs7JRyWJiiE9Su',
  ...
  gbv_girlShine: 'aCPnDw5RmgYAbrnfFqYivj',
  gbv_wgssPdm: 'aBNTzGaGVzG34frWk6AqFz',
  gp_case_management: 'a9jpTGgwoRp4JmebpteKQa',
  ...
  meal_kiiCbpPam: 'aZrwKsGmokUfxXUYzK3zGq',
  meal_ecrec_agMsmeVetPam: 'aw4cm5tqNNxnzmRXnvgdy8',
  meal_eorePdm: 'aTHMDjqm7jodctcrBE4bS7',
  meal_fgdPamShelterSpp: 'a7UVjTrTMwG2dHNdTkBbZ4',
  meal_impactAssessment: 'aDyMothGdBMyDeNJDimtAt',
  meal_nfiPdm: 'aLyuPbbNSWsW6rcAixq3Eu',
  meal_macmiii_hh_baseline: 'aLqjMHpBgazKP4RBWE2tSC',
  ...
  mistosyly_winterization_uhf_2025_2026: 'aWzCBaF8eT9gBEpmBr2pwv',
  ...
  protection_gbv_cm_assessment_intake: 'aYDgEB7JDPH7mKgTYo5ZJQ',
  protection_gbv_cm_case_action: 'a8N56ecDP8J7uYfYdFWNBV',
  protection_gbv_cm_case_closure: 'aG2TZEWjtgnPqSfqGizrMg',
  ...
  protection_gbv_concepts_pre_post: 'aU7Yxm7sjpoG3tjtQ8NYkT',
  ...
  protection_ipaPdm: 'avUGhsv25KzyPrV6cpaM5h',
  protection_ipaTracker: 'amVgfKxFVjdJuNokQdNVzD',
  ...
  shelter_modern_women: 'aAqFiUJAgEVHnKSfhq2HA4',
...
const koboFormTranslation: Record<KoboFormName, string> = {
  awareness_raising_feedback: '[MEAL] Feedback survey - Awareness-raising sessions',
  ...
  gp_case_management: '[Protection] GP Case Management Client feedback form',
  ...
  meal_impactAssessment: '[MEAL] KII/FGD/HH Integrated Programming Impact Assessment',
  ...
  mistosyly_winterization_uhf_2025_2026: 'Winterization UHF 2025-2026',
  ...
  protection_gbv_cm_assessment_intake: '[GBV CM] Assessment and Intake Form',
  protection_gbv_cm_case_action: '[GBV CM] Case Action form',
  protection_gbv_cm_case_closure: '[GBV CM] Case Closure Form',
  protection_gbv_cm_case_follow_up: '[GBV CM] Case Follow up form',
  ...
  protection_ipaPdm: '[MEAL] PAM {Master tool} Protection_IPA/C4P]',
  protection_ipaTracker: '[Protection] IPA Tracker',
  ...
  shelter_modern_women:
    '[LMW] Shelter and Winterization Support to Vulnerable Conflict-Affected Communities in Ukraine',
