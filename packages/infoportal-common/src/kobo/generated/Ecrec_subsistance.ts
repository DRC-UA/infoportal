export namespace Ecrec_subsistance {
  ...
  export interface T {
    ...
    // livelihoods_score/income_spent_nonfood [integer] 2 How much UAH did your household spend on non-food items and services such as health and education in the past month?
    income_spent_nonfood: number | undefined
    // livelihoods_score/lcs_spent_savings [select_one] 3 During the past 30 days, did anyone in your household have to spend savings due to a lack of food or money to buy it?
    lcs_spent_savings: undefined | Option<'lcs_sell_house'>
    // livelihoods_score/lcs_sell_hh_assets [select_one] 4 During the past 30 days, did anyone in your household have to sell household assets/goods (radio, furniture, television, jewellery, etc.) due to a lack of food or money to buy it?
    lcs_sell_hh_assets: undefined | Option<'lcs_sell_house'>
    // livelihoods_score/lcs_decrease_fertilizer [select_one] 5 During the past 30 days, did anyone in your household have to decrease expenditures on fertilizer, pesticide, fodder, animal feed, veterinary care, etc. due to a lack of food or money to buy it?
    lcs_decrease_fertilizer: undefined | Option<'lcs_sell_house'>
    // livelihoods_score/lcs_forrowed_food [select_one] 6 During the past 30 days, did anyone in your household have to borrow money (whether officially or unofficially from friends/family/neighbors) or ask to postpone payments to cover food needs?
    lcs_forrowed_food: undefined | Option<'lcs_sell_house'>
    // livelihoods_score/lcs_sell_productive_assets [select_one] 7 During the past 30 days, did anyone in your household have to sell productive assets or means of transport (sewing machine, wheelbarrow, bicycle, car, etc.) due to a lack of food or money to buy it?
    lcs_sell_productive_assets: undefined | Option<'lcs_sell_house'>
    // livelihoods_score/lcs_reduce_health_expenditures [select_one] 8 During the past 30 days, did anyone in your household have to reduce expenses on essential health (including drugs) due to a lack of food or money to buy it?
    lcs_reduce_health_expenditures: undefined | Option<'lcs_sell_house'>
    // livelihoods_score/lcs_eat_elsewhere [select_one] 9 During the past 30 days, did anyone in your household have to send one or more household members to live elsewhere due to a lack of food or money to buy it?
    lcs_eat_elsewhere: undefined | Option<'lcs_sell_house'>
    // livelihoods_score/lcs_degrading_income_source [select_one] 10 During the past 30 days, did anyone in your household have to engage in illegal, socially degrading, high-risk, exploitive or life-threatening jobs or income-generating activities (e.g., smuggling, theft, joining armed groups, prostitution) due to a lack of food or money to buy it?
    lcs_degrading_income_source: undefined | Option<'lcs_sell_house'>
    // livelihoods_score/lcs_ask_stranger [select_one] 11 During the past 30 days, did anyone in your household have to beg (i.e., ask strangers on the streets for money or food) and/or scavenge due to a lack of food or money to buy it?
    lcs_ask_stranger: undefined | Option<'lcs_sell_house'>
    // livelihoods_score/lcs_sell_house [select_one] 12 During the past 30 days, did your household have to mortgage/sell the house where your household was permanently living in or (in part or in full) land due to a lack of food or money to buy it?
    lcs_sell_house: undefined | Option<'lcs_sell_house'>
    // livelihoods_score/lcs_reason [select_multiple] 13 What were the main reasons why your household decided to use these strategies?
    ...
    // contamination/known_contamination_next [select_one] 4 Do you know of any contamination (e.g. unexploded ordnance) on land of a neighbour or a small-scale farmer close by?
    known_contamination_next: undefined | Option<'known_contamination_next'>
    // contamination/contamination_impact_next [select_one] 5 Do you know if this individual(s) still continues to farm their land?
    contamination_impact_next: undefined | Option<'contamination_impact_next'>
    // shelter_needs/apartment_replace [select_multiple] 1. Does your house or apartment need to replace windows, entrance doors, or the roof due to wear and tear, poor quality, or drafts?
    apartment_replace: undefined | Option<'apartment_replace'>[]
    // shelter_needs/apartment_replace_other [text] 1.1 If other, specify
    apartment_replace_other: string | undefined
    // shelter_needs/apartment_damaged [select_multiple] 2. Were the windows, entrance door, or roof of your house or apartment damaged due to shelling or other combat-related actions?
    apartment_damaged: undefined | Option<'apartment_damaged'>[]
    // shelter_needs/apartment_damaged_other [text] 2.1 If other, specify
    apartment_damaged_other: string | undefined
    ...
    // ass_inc/calc_gen_sc_inc [calculate] Eligible
  ...
  export const options = {
    ...
    apartment_replace: {
      windows: `Yes, the windows need to be replaced`,
      entracne_door: `Yes, the entrance door needs to be replaced`,
      roof: `Yes, the roof needs repair or replacement`,
      satisfactory_condition: `No, everything is in satisfactory condition`,
      other: `Other`,
    },
    apartment_damaged: {
      windows: `Yes, the windows were damaged`,
      entracne_door: `Yes, the entrance door was damaged`,
      roof: `Yes, the roof was damaged`,
      no_damage: `No, there was no damage`,
      other: `Other`,
    },
    ben_det_prev_oblast: {
      cherkaska: `Cherkaska`,
  ...
  export const map = (_: Record<keyof T, any>): T =>
    ({
      ...
      apartment_replace: _.apartment_replace?.split(' '),
      apartment_damaged: _.apartment_damaged?.split(' '),
