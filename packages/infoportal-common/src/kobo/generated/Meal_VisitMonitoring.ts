export namespace Meal_visitMonitoring {
  ...
  export interface T {
    ...
    // md/visit_number [text] Number of Field Visits Conducted
    visit_number: string | undefined
    // pa/mdt [select_multiple] What sector(s) were covered in the field visit?
    mdt: undefined | Option<'mdt'>[]
    // pa/mdo [text] If Other, please specify
    mdo: string | undefined
    // pa/paoth [text] If Other, what monitoring activity:
    paoth: string | undefined
    // pa/pas [select_one] If Shelter:
    pas: undefined | Option<'pas'>
    // pa/mdc [text] If relevant, provide the name of the infrastructure/collective center:
    mdc: string | undefined
    // pa/pan [select_multiple] If Basic Needs distribution, then:
    ...
    // pa/whom [text] Which program team members were present?
    ...
    ssy: undefined | Option<'has_comments'>
    // ssc/sst [select_multiple] If yes, please select the type of situation:
    sst: undefined | Option<'sst'>[]
    // ssc/sso [text] Other:
    sso: string | undefined
    // general_observations/main_objective [text] Main Objective
    main_objective: string | undefined
    // general_observations/target_groups [text] Target Groups
    target_groups: string | undefined
    // general_observations/activity_overview [text] Activity Overview
    activity_overview: string | undefined
    // general_observations/photo1 [image] The photo of the visit
    photo1: string
    // general_observations/photo2 [image] The photo of the visit
    photo2: string
    // general_observations/photo3 [image] The photo of the visit
    photo3: string
    // general_observations/photo4 [image] The photo of the visit
    photo4: string
    // satisfaction_feedback/satisfaction_level [text] Satisfaction Level
    satisfaction_level: string | undefined
    // satisfaction_feedback/FGD_part [text] Focus Group Discussions (FGDs)
    FGD_part: string | undefined
    // satisfaction_feedback/photo5 [image] Upload Photo Documentation
    photo5: string
    // satisfaction_feedback/photo6 [image] Upload Photo Documentation
    photo6: string
    // satisfaction_feedback/photo7 [image] Upload Photo Documentation
    photo7: string
    // satisfaction_feedback/photo8 [image] Upload Photo Documentation
    photo8: string
    // satisfaction_feedback/feedback_org [text] Feedback from Organizers
    feedback_org: string | undefined
    // satisfaction_feedback/stakeholder_interview [text] Stakeholder Interviews
    stakeholder_interview: string | undefined
    // satisfaction_feedback/overall_observation [text] Overall Observations
    overall_observation: string | undefined
    // satisfaction_feedback/photo9 [image] The photo of the visit
    photo9: string
    // satisfaction_feedback/photo10 [image] The photo of the visit
    photo10: string
    // satisfaction_feedback/photo11 [image] The photo of the visit
    photo11: string
    // satisfaction_feedback/photo12 [image] The photo of the visit
    photo12: string
    // safety_followup/air_alarm [select_one] Was there an air alarm during the distribution?
    air_alarm: undefined | Option<'has_comments'>
    // safety_followup/red_alarm [select_one] Was there a red alarm (according to DRC system)?
    red_alarm: undefined | Option<'has_comments'>
    // safety_followup/shelter_available [select_one] If yes to red alarm: Was there a shelter available for the team during this alarm?
    shelter_available: undefined | Option<'has_comments'>
    // safety_followup/shelter_no_reason [text] If no, why?
    shelter_no_reason: string | undefined
    // safety_followup/space_suitable [select_one] Was the space suitable for the number of people present? (Ensure that the venue is spacious enough to accommodate all participants comfortably, with appropriate measures in place to manage crowds effectively.)
    space_suitable: undefined | Option<'vislogo'>
    // safety_followup/space_not_suitable_reason [text] If no, why?
    space_not_suitable_reason: string | undefined
    // safety_followup/wheelchair_access [select_one] Was there a ramp/ easy access for individuals using a wheelchair/ with additional access issues?
    wheelchair_access: undefined | Option<'vislogo'>
    // safety_followup/no_access_reason [text] If no, why?
    no_access_reason: string | undefined
    // safety_followup/weather_proof [select_one] Was the site of the distribution weather proof? i.e. shelter from rain/sunshine.
    weather_proof: undefined | Option<'vislogo'>
    // safety_followup/weather_not_proof_reason [text] If no, why?
    weather_not_proof_reason: string | undefined
    // cca/ccm [select_one] Did DRC staff inform beneficiaries of how they can provide feedback through the CFM mechanism?
    ccm: undefined | Option<'has_comments'>
    ...
    ccs: undefined | Option<'has_comments'>
    // cca/ccsn [text] If no, please explain why:
    ccsn: string | undefined
    // cca/ccd [select_one] Did any beneficiaries report not feeling safe around DRC staff?
    ccd: undefined | Option<'has_comments'>
    // cca/ccdn [text] If yes, please explain why:
    ccdn: string | undefined
    // cca/ccc [select_one] Were CFM flyers distributed?
    ccc: undefined | Option<'has_comments'>
    // cca/cccn [text] If no, please explain why:
    cccn: string | undefined
    // cca/psea [select_one] Were PSEA flyers distributed?
    psea: undefined | Option<'vislogo'>
    // cca/psean [text] If no, please explain why:
    psean: string | undefined
    // pmi/pmid [select_one] Were individuals asked for permission to collect their data?
    pmid: undefined | Option<'has_comments'>
    // pmi/pmidn [text] If no, please explain why:
    pmidn: string | undefined
    // pmi/pmic [select_one] For vulnerable beneficiaries, were issues handled with care and confidentiality?
    pmic: undefined | Option<'vislogo'>
    ...
    qtip: undefined | Option<'has_comments'>
    ...
    qtia: undefined | Option<'has_comments'>
    ...
    visb: undefined | Option<'has_comments'>
    // vis/visbn [text] If no, please explain why:
    visbn: string | undefined
    // vis/vislogo [select_one] Was the donor logo visible?
    vislogo: undefined | Option<'vislogo'>
    // vis/vislogon [text] If no, please explain why:
    vislogon: string | undefined
    // vis/visf [select_one] Any critical concerns to flag?
    visf: undefined | Option<'has_comments'>
    ...
    // additional_comments_grp/has_comments [select_one] Do you have any other comments or concerns that you would like to share?
    has_comments: undefined | Option<'has_comments'>
    // additional_comments_grp/fcpc [text] If yes, please specify.
  ...
  export const options = {
    ...
    mdp: {
      ...
      mykyta_kovalenko: `Mykyta Kovalenko`,
      artem_koniev: `Artem Koniev`,
      svitlana_shershnieva: `Svitlana Shershnieva`,
      liliia_antonova: `Liliia Antonova`,
      liubov_yefremova: `Liubov Yefremova`,
      oleksandr_oleksandrov: `Oleksandr Oleksandrov`,
    ...
    mdd_001: {
      ...
      '371_dmfa': `UKR-000371 DMFA`,
      '372_echo': `UKR-000372 ECHO 2024-2025`,
      '373_novonordisk': `UKR-000373 Novo-Nordisk`,
      '378_dmfa': `UKR-000378 DANISH MoFA`,
      ukr000380_danida: `UKR-000380 DANIDA SPA Top-Up 2024-2025`,
      '385_pooledfunds': `UKR-000385 Pooled Funds`,
      '386_danishfoundations': `UKR-000386 Danish Foundations`,
      '387_wra': `UKR-000387 WRA`,
      ukr000388_bha: `UKR-000388 BHA Economic Recovery 2024-2025`,
      ukr000390_uhf9: `UKR-000390 UHF 9 Winterization`,
      '392_hgbf': `UKR-000392 HGBF HDP`,
      '396_dmfa': `UKR-000396 DANISH MoFA`,
      ukr000397_gffo: `UKR-000397 GFFO`,
      '398_sdc': `UKR-000398 SDC`,
      ukr000399_sdc: `UKR-000399 SDC3`,
      '403_danishemergency': `UKR-000403 Danish Emergency`,
    ...
    visit_type: {
      shadowing: `Monitoring visit: Shadowing/”tag-along”`,
    ...
    pan: {
      mpca: `Monitoring MPCA`,
      hkmv: `Monitoring HKMV (Family Hygiene Kits on the Move)`,
      hkf: `Monitoring HKF (Family Hygiene Kits)`,
      wkb: `Monitoring WKB (Baby winter kits)`,
      cfr: `Monitoring CFR (Cash for Rent)`,
      bk: `Monitoring BK (Baby Hygiene Kits)`,
      ks: `Monitoring KS (Kitchen sets)`,
      nfkf: `Monitoring NFKF (Family NFI kits + kitchen set (KS))`,
      bln: `Monitoring BLN (High thermal blanket)`,
      nficc: `Monitoring NFICC (NFI kit for the Collective Center)`,
      esk: `Monitoring ESK (Emergency Shelter kit)`,
      hkcc: `Monitoring HKCC (Insitutional Hygiene kit for Collective Center)`,
    ...
    pae: {
      ...
      entrepreneurship_training: `Monitoring Entrepreneurship Training`,
      restoration_agricultural_market: `Monitoring Restoration, creation or reconstruction of agricultural market`,
    },
    pas: {
      har: `Monitoring House/ apartment repair (mid-term assessment of the repair work)`,
      harm: `Monitoring House/ apartment repair (Handover completion visit)`,
      nta: `Monitoring House/ apartment repair (Non-Technical visit)`,
      ipb: `Monitoring Institution/ public building repair (mid-term assessment of the repair work)`,
      ipbm: `Monitoring Institution/ public building repair (Handover completion visit)`,
      cfr: `Monitoring Cash for Repair (cash for building repair registration)`,
      cfs: `Monitoring Cash for Shelter (cash for building repair assessment)`,
    },
    pal: {
    ...
    pap: {
      ...
      pss_s: `Monitoring PSS (group and individual)`,
      pss_pfa: `Monitoring PSS (PFA)`,
      gbv_kit: `Monitoring GBV Dignity Kit Distribution`,
      obse: `Observation`,
      cbp: `Community based Protection`,
      cases_protection: `Monitoring GBV case management`,
      awareness_protection: `Monitoring GBV Awareness Raising`,
      gbv_training: `Monitoring GBV Training`,
      wgss_protection: `Monitoring WGSS`,
      women_rise: `Monitoring Women Rise`,
      'girls-shine_protection': `Monitoring Girls Shine`,
      inclusion_training_protection: `Monitoring Inclusion Trainings`,
      advocacy_protection: `Monitoring Advocacy Events`,
      referral_training: `Monitoring Referrals training`,
      opds: `Monitoring OPDs support`,
    },
    pao: {
      eose: `Monitoring EORE session / ToT`,
    },
    has_comments: {
      yes: `Yes`,
      no: `No`,
    ...
    vislogo: {
      yes: `Yes`,
      no: `No`,
      ntr: `Not relevant for this activity`,
    },
    sei: {
    ...
    undefined: {
      ...
      needed: `Not needed`,
      mpca: `MPCA`,
      hkmv_basic: `HKMV (Family Hygiene Kits on the Move)`,
      hkf_basic: `HKF (Family Hygiene Kits)`,
      wkb_basic: `WKB (Baby winter kits)`,
      cfr_basic: `CFR (Cash for Rent)`,
      bk_basic: `BK (Baby Hygiene Kits)`,
      ks_basic: `KS (Kitchen sets)`,
      nfkf_basic: `NFKF (Family NFI kits + kitchen set (KS))`,
      bln_basic: `BLN (High thermal blanket)`,
      nficc_basic: `NFICC (NFI kit for the Collective Center)`,
      esk_basic: `ESK (Emergency Shelter kit)`,
      hkcc_basic: `HKCC (Insitutional Hygiene kit for Collective Center)`,
      cff_basic: `CFF (Cash for Fuel)`,
      wsk_basic: `WSK (Winterization Supplies Kit - Ukraine, IOM)`,
      mmg_ecrec: `Monitoring Micro grants`,
      msg_ecrec: `Monitoring SME grants`,
      mag_ecrec: `Monitoring Agro grants`,
      mvg_ecrec: `Monitoring VET grant`,
      entrepren_ecrec: `Entrepreneurship Training`,
      har_shelter: `House/ apartment repair (mid-term assessment of the repair work)`,
      harm_shelter: `House/ apartment repair (Handover completion visit)`,
      ipb_shelter: `Institution/ public building repair (mid-term assessment of the repair work)`,
      ipbm_shelter: `Institution/ public building repair (Handover completion visit)`,
      cfr_shelter: `Cash for Repair (cash for building repair registration)`,
      cfs_shelter: `Cash for Shelter (cash for building repair assessment)`,
      eose_eore: `EORE session / ToT`,
      mc_lau: `Mobile Clinic`,
      pss_protection: `PSS`,
    },
  } as const
