...
feedback_type: {
	'apprec_com': `0. Подяка або компліменти.`,
	'request_info': `1. Запит на інформацію.`,
	'request_assistance': `2. Запит на підтримку чи допомогу.`,
	'non_s_feedback': `3. Нечутливий програмний зворотній зв'язок.`,
	'sen_feedback': `4. Конфіденційне звернення - повідомляється про проблему захисту.`,
	'coc': `5. Конфіденційне звернення -  порушення Кодексу поведінки персоналом і представниками ДРБ.`,
	'violation_other': `6. Конфіденційне звернення - серйозне порушення іншим гуманітарним учасником ( не працівником ДРБ).`,
	'sen_safety': `7. Конфіденційне звернення- загроза безпеці.`
},
sub_category: {
	...
	'payment': `1.4 Інформація про терміни виплат від ДРБ`,
	'deadline': `1.5 Інформація про строки та процедури проведення ремонтних робіт (у т.ч грошовий переказ)`,
	'ukrpost': `1.6 Інформація щодо діяльності Укрпошти (строки виплат, смс повідомлення, затримки)`,
	'personal': `1.7 Інформація про зміни особистих даних (ім'я, місцезнаходження, адреса, телефон, статус)`,
	'hh_change': `1.8 Інформація про зміни в домогосподарстві (кількість членів тощо)`,
	'other_ngo': `1.9 Інформація щодо контактів іншої НГО`,
