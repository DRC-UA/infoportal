...
export type Option<T extends keyof typeof options> = keyof (typeof options)[T]
  ...
  'topic_activity': string | undefined,
	  // gi/date_final_session [date] Date of final session
  'date_final_session': Date | undefined,
...
project: {
	...
	'ukr000330_sdc2': `UKR-000330 (SDC)`,
	'ukr000345_bha2': `UKR-000345 (BHA)`,
	'ukr000347_danida': `UKR-000347 (Danida)`,
	'ukr000355_dfma': `UKR-000355 (DFMA)`,
...
activity: {
	...
	'psychosocial_support': `Psychosocial support services (mobile and static) for GBV survivors and those at-risk (individual and group)- including Girl Shine, Women Rise`,
...
export const map = (_: Record<keyof T, any>): T => ({
	...
	date_final_session: _.date_final_session ? new Date(_.date_final_session) : undefined,
}) as T
}