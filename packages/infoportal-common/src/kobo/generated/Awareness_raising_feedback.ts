export namespace Awareness_raising_feedback {
  export type Option<T extends keyof typeof options> = keyof (typeof options)[T]
  // Form id: aGykmownZs7JRyWJiiE9Su
  export interface T {
    start: string
    end: string
    // note_hello [note] This survey was created solely for the purpose of assessing the quality of the support provided. Your responses will not be shared with any third parties outside the organization. They will only be used in aggregated form for statistical analysis. Participation in the survey is voluntary, and you may choose not to answer any questions or to stop participating at any time. We appreciate your participation, as your responses will help us evaluate the effectiveness of our work and improve it in the future.
    note_hello: string
    // general_information/type_awareness_raising [select_one] Type of awareness raising
    type_awareness_raising: undefined | Option<'type_awareness_raising'>
    // general_information/interviewer [select_one] Interviewer
    interviewer: undefined | Option<'interviewer'>
    // general_information/office [select_one] DRC Office
    office: undefined | Option<'office'>
    // general_information/donor [select_one] Donor
    donor: undefined | Option<'donor'>
    // general_information/date_session [date] Date of session
    date_session: Date | undefined
    // general_information/ben_det_oblast [select_one] Location of session OBLAST
    ben_det_oblast: undefined | Option<'ben_det_oblast'>
    // general_information/ben_det_raion [select_one] Location of session RAION
    ben_det_raion: undefined | Option<'ben_det_raion'>
    // general_information/ben_det_hromada [select_one] Location of session HROMADA
    ben_det_hromada: undefined | Option<'ben_det_hromada'>
    // general_information/ben_det_settlement [select_one_from_file] Location of session SETTLEMENT
    ben_det_settlement: string
    // general_information/location_premise [text] Location (premise)
    location_premise: string | undefined
    // general_information/lawyer [text] Facilitating lawyer
    lawyer: string | undefined
    // general_information/topic [text] Which topic was the information session about?
    topic: string | undefined
    // preliminary_information/age [integer] What is your age?
    age: number | undefined
    // preliminary_information/gender [select_one] What is your gender?
    gender: undefined | Option<'gender'>
    // preliminary_information/oblast_service_provision [select_one] Oblast of service provision
    oblast_service_provision: undefined | Option<'oblast_service_provision'>
    // survey_questions/information_presented_clear [select_one] Was the information presented clear and easy to understand?
    information_presented_clear: undefined | Option<'informed_cfm'>
    // survey_questions/facilitator_engage [select_one] Did the facilitator engage the audience and respond to audience’s questions?
    facilitator_engage: undefined | Option<'informed_cfm'>
    // survey_questions/location_timing_convenient [select_one] Was the session location and timing convenient for you?
    location_timing_convenient: undefined | Option<'informed_cfm'>
    // survey_questions/more_informed_topic [select_one] Do you feel more informed about the topic after attending this session?
    more_informed_topic: undefined | Option<'informed_cfm'>
    // survey_questions/aspects_session [text] What aspects of the awareness-session did you find most helpful or informative
    aspects_session: string | undefined
    // survey_questions/topics_unclear [text] Which topics of information shared during the session were unclear or difficult to understand?
    topics_unclear: string | undefined
    // survey_questions/session_meet_expectations [select_one] Did the session meet your expectations?
    session_meet_expectations: undefined | Option<'informed_cfm'>
    // survey_questions/not_session_meet_expectations [text] What could be improved for future sessions?
    not_session_meet_expectations: string | undefined
    // survey_questions/recommend_session [select_one] Would you recommend this session to others
    recommend_session: undefined | Option<'informed_cfm'>
    // survey_questions/not_recommend_session [text] Are there any suggestions or other comments you would like to include?
    not_recommend_session: string | undefined
    // survey_questions/informed_legal_session [select_one] Did you feel well informed about this legal awareness raising session?
    informed_legal_session: undefined | Option<'informed_cfm'>
    // survey_questions/not_informed_legal_session [text] If no, what could we have done to better inform you about the sessions or individual assistance available to you?
    not_informed_legal_session: string | undefined
    // survey_questions/safe_travelling [select_one] Did you feel safe at all times travelling to receive legal awareness raising information sessions (from your place)?
    safe_travelling: undefined | Option<'informed_cfm'>
    // survey_questions/not_safe_travelling [text] If no, what could have been done by the organization to make you feel safer?
    not_safe_travelling: string | undefined
    // survey_questions/lawyer_respect [select_one] Did you feel that the lawyer(s) facilitating the sessions treated you with respect during the session?
    lawyer_respect: undefined | Option<'informed_cfm'>
    // survey_questions/not_lawyer_respect [text] If no, would you mind telling us when or where? Would you mind telling us why?
    not_lawyer_respect: string | undefined
    // survey_questions/satisfied_session [select_one] Were you satisfied with the session provided (e.g. it was useful/not useful; it was adequate/not adequate to your needs)?
    satisfied_session: undefined | Option<'informed_cfm'>
    // survey_questions/not_satisfied_session [text] If no, would you mind telling us why you are not satisfied?
    not_satisfied_session: string | undefined
    // survey_questions/people_needing [select_one] Do you know of people needing the information presented who were excluded from the session provided?
    people_needing: undefined | Option<'people_needing'>
    // survey_questions/yes_people_needing [text] If yes, who was mainly excluded?
    yes_people_needing: string | undefined
    // survey_questions/informed_cfm [select_one] Have you been informed about the CFM mechanism and do think you could easily channel the suggestion or lodge a complaint in needed?
    informed_cfm: undefined | Option<'informed_cfm'>
    // survey_questions_pss/information_presented_clear_pss [select_one] Was the information presented clear and easy to understand?
    information_presented_clear_pss: undefined | Option<'recommend_session_gbv'>
    // survey_questions_pss/facilitator_engage_pss [select_one] Did the facilitator engage the audience?
    facilitator_engage_pss: undefined | Option<'more_informed_topic_gbv'>
    // survey_questions_pss/location_timing_convenient_pss [select_one] Was the session location and timing convenient for you?
    location_timing_convenient_pss: undefined | Option<'recommend_session_gbv'>
    // survey_questions_pss/more_informed_topic_pss [select_one] Do you feel more informed after attending this session?
    more_informed_topic_pss: undefined | Option<'more_informed_topic_gbv'>
    // survey_questions_pss/aspects_session_pss [text] What aspects of the awareness-session did you find most helpful or informative?
    aspects_session_pss: string | undefined
    // survey_questions_pss/topics_unclear_pss [text] Which information shared during the session were unclear or difficult to understand?
    topics_unclear_pss: string | undefined
    // survey_questions_pss/session_meet_expectations_pss [select_one] Did the session meet your expectations?
    session_meet_expectations_pss: undefined | Option<'recommend_session_gbv'>
    // survey_questions_pss/not_session_meet_expectations_pss [text] What could be improved for future sessions?
    not_session_meet_expectations_pss: string | undefined
    // survey_questions_pss/recommend_session_pss [select_one] Would you recommend this session to others
    recommend_session_pss: undefined | Option<'recommend_session_gbv'>
    // survey_questions_pss/informed_cfm_pss [select_one] Have you been informed about the CFM mechanism and do think you could easily channel the suggestion or lodge a complaint in needed?
    informed_cfm_pss: undefined | Option<'recommend_session_gbv'>
    // survey_questions_pss/suggestions_session_pss [text] Are there any suggestions or other comments you would like to include?
    suggestions_session_pss: string | undefined
    // survey_questions_gbv/satisfied_overall_gbv [select_one] How satisfied are you with the overall quality of the awareness-raising session you attended?
    satisfied_overall_gbv: undefined | Option<'satisfied_overall_gbv'>
    // survey_questions_gbv/information_presented_clear_gbv [select_one] Was the information presented clear and easy to understand?
    information_presented_clear_gbv: undefined | Option<'recommend_session_gbv'>
    // survey_questions_gbv/facilitator_engage_gbv [select_one] Did the facilitator engage the audience and allow for questions?
    facilitator_engage_gbv: undefined | Option<'more_informed_topic_gbv'>
    // survey_questions_gbv/location_timing_convenient_gbv [select_one] Was the session location and timing convenient for you?
    location_timing_convenient_gbv: undefined | Option<'recommend_session_gbv'>
    // survey_questions_gbv/informed_session_gbv [select_one] Did you feel well informed about this session?
    informed_session_gbv: undefined | Option<'feedback_responded_gbv'>
    // survey_questions_gbv/more_informed_topic_gbv [select_one] Do you feel more informed about the topic after attending this session?
    more_informed_topic_gbv: undefined | Option<'more_informed_topic_gbv'>
    // survey_questions_gbv/aspects_session_gbv [text] What aspects of the awareness-session did you find most helpful or informative
    aspects_session_gbv: string | undefined
    // survey_questions_gbv/topics_unclear_gbv [text] Which topics of information shared during the session were unclear or difficult to understand?
    topics_unclear_gbv: string | undefined
    // survey_questions_gbv/session_meet_expectations_gbv [select_one] Did the session meet your expectations?
    session_meet_expectations_gbv: undefined | Option<'recommend_session_gbv'>
    // survey_questions_gbv/not_session_meet_expectations_gbv [text] What could be improved for future sessions?
    not_session_meet_expectations_gbv: string | undefined
    // survey_questions_gbv/recommend_session_gbv [select_one] Would you recommend this session to others
    recommend_session_gbv: undefined | Option<'recommend_session_gbv'>
    // survey_questions_gbv/safe_travelling_gbv [select_one] Did you feel safe at all times travelling to participate in awareness-raising session the assistance/service (to/from your place), while participating in session, and upon return to your place?
    safe_travelling_gbv: undefined | Option<'feedback_responded_gbv'>
    // survey_questions_gbv/safe_travelling_gbv_no [text] If no, what could have been done by the organization to make you feel safer?
    safe_travelling_gbv_no: string | undefined
    // survey_questions_gbv/treated_respect_gbv [select_one] Did you feel that the staff treated you with respect during the intervention?
    treated_respect_gbv: undefined | Option<'feedback_responded_gbv'>
    // survey_questions_gbv/treated_respect_gbv_no [text] If no, would you mind telling us when or where? Would you mind telling us why?
    treated_respect_gbv_no: string | undefined
    // survey_questions_gbv/give_feedback_gbv [select_one] Where you told about how you can give your complaint/feedback or questions about the assistance?
    give_feedback_gbv: undefined | Option<'feedback_responded_gbv'>
    // survey_questions_gbv/feedback_responded_gbv [select_one] If you have ever given feedback or made a complaint, was it responded to or followed up?
    feedback_responded_gbv: undefined | Option<'feedback_responded_gbv'>
    // survey_questions_gbv/feedback_responded_gbv_no [text] If no, would you mind telling me which are the issues / what happened?
    feedback_responded_gbv_no: string | undefined
    // survey_questions_gbv/suggestions_session_gbv [text] Are there any suggestions or other comments you would like to include?
    suggestions_session_gbv: string | undefined
    // comments [text] Any other Comments
  ...
  export const options = {
    ...
    feedback_responded_gbv: {
      yes_completely: `Yes, completely`,
      yes_somewhat: `Yes, somewhat`,
      not_all: `No, not at all`,
      na: `No answer`,
    },
    satisfied_overall_gbv: {
