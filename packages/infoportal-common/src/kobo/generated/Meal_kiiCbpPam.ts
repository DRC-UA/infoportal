export namespace Meal_kiiCbpPam {
  export type Option<T extends keyof typeof options> = keyof (typeof options)[T]
  // Form id: aZrwKsGmokUfxXUYzK3zGq
  export interface T {
    start: string
    end: string
    // date [date] Date
    date: Date | undefined
    // basic_information/name_cbp [text] 1.1. Name of community based structure (CBS)
    name_cbp: string | undefined
    // basic_information/oblast [select_one] 1.2.1. Oblast
    oblast: undefined | Option<'oblast'>
    // basic_information/raion [select_one] 1.2.2. Raion
    raion: undefined | Option<'raion'>
    // basic_information/hromada [select_one] 1.2.3. Hromada
    hromada: undefined | Option<'hromada'>
    // basic_information/settlement [select_one_from_file] 1.2.4. Settlement
    settlement: string
    // basic_information/project [select_one] 1.3. Donor/# of project
    project: undefined | Option<'project'>
    // basic_information/respondent_role [text] 1.4. Respondent role in the CBS:
    respondent_role: string | undefined
    // basic_information/type_support [select_multiple] 1.5. Type of support the CBS/CBP focal point received
    type_support: undefined | Option<'type_support'>[]
    // basic_information/type_support_other [text] 1.5.1. If "Other", please specify
    type_support_other: string | undefined
    // protection_outcomes/support_community_ability [select_one] 2.1. Since receiving support, have you observed changes in your community’s ability to address protection issues?
    support_community_ability: undefined | Option<'support_community_ability'>
    // protection_outcomes/community_ability_situation_worsened [text] 2.1.1. If "Situation worsened ", please specify
    community_ability_situation_worsened: string | undefined
    // protection_outcomes/issues_better_respond [text] 2.2. What types of protection issues is your CBS/focal point better able to respond to now?
    issues_better_respond: string | undefined
    // protection_outcomes/reported_feeling_safe [select_one] 2.3. Have people in your community reported feeling safe or more supported as a result of the CBS activities since the support?
    reported_feeling_safe: undefined | Option<'reported_feeling_safe'>
    // satisfaction_support/satisfied_support [select_one] 3.1. Overall, how satisfied are you with the support received?
    satisfied_support: undefined | Option<'satisfied_support'>
    // satisfaction_support/satisfied_support_bad [text] 3.1.1. If dissatisfied/very dissatisfied could you, please tell us more details?
    satisfied_support_bad: string | undefined
    // satisfaction_support/support_meet [select_one] 3.2. To what extent did the support meet the needs and priorities of your CBS/community?
    support_meet: undefined | Option<'support_meet'>
    // satisfaction_support/support_meet_bad [text] 3.2.1. If partially or unmet needs could you, please tell us more details?
    support_meet_bad: string | undefined
    // satisfaction_support/support_improving_ability [select_one] 3.3. How useful was the support for improving your CBS’s ability to carry out protection activities?
    support_improving_ability: undefined | Option<'support_improving_ability'>
    // satisfaction_support/support_improving_ability_bad [text] 3.3.1. If not useful could you, please tell us more details?
    support_improving_ability_bad: string | undefined
    // inclusion_reach/support_vulnerable_groups [select_one] 4.1. Do you feel the support enabled CBS/focal point to better include vulnerable groups
    support_vulnerable_groups: undefined | Option<'support_vulnerable_groups'>
    // inclusion_reach/support_vulnerable_groups_no [text] 4.1.1 If no, please explain
    support_vulnerable_groups_no: string | undefined
    // inclusion_reach/groups_barriers_participating [text] 4.2. Which groups still face barriers in participating in or benefitting from CBS activities
    groups_barriers_participating: string | undefined
    // sustainability_recommendations/continue_supporting_community [select_one] 5.1. Do you feel your CBS/focal point can continue supporting community protection activities without further assistance?
    continue_supporting_community: undefined | Option<'continue_supporting_community'>
    // sustainability_recommendations/additional_support_need [text] 5.2. What additional support would you need to sustain or strengthen your CBS’s protection role?
    additional_support_need: string | undefined
    // dmfa_indicator/activities_making_safer [select_one] In your view, have DRC’s activities contributed to making your community a safer and more supportive environment for people to remain or return?
    activities_making_safer: undefined | Option<'activities_making_safer'>
    // aap/informed_services [select_one] 6.1. Do you feel well informed about the services provided by DRC?
    informed_services: undefined | Option<'staff_respect'>
    // aap/informed_services_no [text] 6.1.1. If ‘No’ Could you, please tell us more details?
    informed_services_no: string | undefined
    // aap/taken_into_account [select_one] 6.2. Were your views taken into account by the organization about the assistance you received?
    taken_into_account: undefined | Option<'staff_respect'>
    // aap/taken_into_account_no [text] 6.2.1. If no, would you mind telling me how it is that your views were not taken into account?
    taken_into_account_no: string | undefined
    // aap/report_employee [select_one] 6.3. Do you know how and where to report if a DRC employee requested something from you in exchange for receiving assistance, made you feel uncomfortable in anyway or insulted you?
    report_employee: undefined | Option<'staff_respect'>
    // aap/report_employee_no [text] 6.3.1. If ‘No’ Could you, please tell us more details?
    report_employee_no: string | undefined
    // aap/channel_suggestion [select_one] 6.4. If you had a suggestion or problem with the support provided by DRC, do you think you could channel the suggestion or lodge a complaint?
    channel_suggestion: undefined | Option<'staff_respect'>
    // aap/channel_suggestion_yes [select_one] 6.4.1. If "Yes", have you provided any feedback/ suggestions, complaints, or questions?
    channel_suggestion_yes: undefined | Option<'channel_suggestion_yes'>
    // aap/complaint_question [select_one] 6.4.1.1. If ‘Complaint or question’ Has someone from DRC responded to your complaint or question?
    complaint_question: undefined | Option<'complaint_question'>
    // aap/channel_suggestion_no [text] 6.4.2. If ‘No’ Could you, please tell us more details?
    channel_suggestion_no: string | undefined
    // aap/staff_respect [select_one] 6.5. Do you feel that DRC staff treated you with respect during the intervention?
    staff_respect: undefined | Option<'staff_respect'>
    // aap/staff_respect_no [text] 6.5.1. If ‘No’ Could you, please tell us more details?
    staff_respect_no: string | undefined
    // information_relevant [text] Any other information as relevant:
    information_relevant: string | undefined
  }
  export const options = {
    ...
    type_support: {
      ...
      material_support: `Material support (equipment, IEC materials, small grants etc.)`,
      technical_guidance: `Technical guidance or mentoring`,
      linkages_authorities: `Linkages with authorities or other services.`,
      other: `Other`,
    },
    support_community_ability: {
      yes: `Yes, significant improvement`,
      some: `Some improvement`,
      no: `No change`,
      situation_worsened: `Situation worsened`,
    },
    reported_feeling_safe: {
      many: `Yes, many`,
      some: `Yes, some`,
      no: `No`,
      dk: `Don’t know`,
    ...
    support_meet: {
      fully: `Fully met needs`,
      partially: `Partially met needs`,
      not: `Did not meet needs`,
    },
    support_improving_ability: {
      very: `Very useful`,
      somewhat: `Somewhat useful`,
      not: `Not useful`,
    },
    support_vulnerable_groups: {
      significantly: `Yes, significantly`,
      somewhat: `Yes, somewhat`,
      no: `No`,
      dk: `Don’t know`,
    },
    continue_supporting_community: {
      fully: `Yes, fully`,
      partially: `Yes, partially`,
      no: `No`,
    },
    activities_making_safer: {
      significantly: `Yes, significantly`,
      somewhat: `Yes, somewhat`,
      no_change: `No change`,
      situation_worsened: `No, the situation has worsened`,
      dk: `Don’t know`,
    },
    staff_respect: {
      yes: `Yes`,
  ...
  export const map = (_: Record<keyof T, any>): T =>
    ({
      ...
      type_support: _.type_support?.split(' '),
    }) as T
}
