export namespace Gp_case_management {
  ...
  export interface T {
    ...
    // preliminary_information/date [date] Date of survey
    date: Date | undefined
    // preliminary_information/project [select_one] Project
    project: undefined | Option<'project'>
    // preliminary_information/oblast_provision [select_one] Oblast of service provision
    oblast_provision: undefined | Option<'oblast_provision'>
    // preliminary_information/office [select_one] DRC office
    office: undefined | Option<'office'>
    // preliminary_information/staff_code [select_one] Staff code
    ...
    // meaningful_access/many_met_caseworker [integer] How many times have you met with the caseworker since you started services with us
    many_met_caseworker: number | undefined
    // meaningful_access/option_support_person [select_one] Were you offered the option of having a support person with you?
    option_support_person: undefined | Option<'caseworker_agreed_contact'>
    // meaningful_access/option_support_person_explain [text] Please explain
    option_support_person_explain: string | undefined
    // meaningful_access/services_accessible_location [select_one] Were our services accessible in terms of location?
    services_accessible_location: undefined | Option<'caseworker_agreed_contact'>
    // meaningful_access/services_accessible_location_explain [text] Please explain
    services_accessible_location_explain: string | undefined
    // meaningful_access/accessible_operating_hours [select_one] Were our services accessible in terms of operating hours?
    accessible_operating_hours: undefined | Option<'caseworker_agreed_contact'>
    // meaningful_access/accessible_operating_hours_explain [text] Please explain
    accessible_operating_hours_explain: string | undefined
    // meaningful_access/information_services_available [select_one] Did you receive information about what services were available and what your options were?
    information_services_available: undefined | Option<'caseworker_agreed_contact'>
    // meaningful_access/information_services_available_explain [text] Please explain
    information_services_available_explain: string | undefined
    // meaningful_access/satisfied_caseworke_knowledge [select_one] How satisfied are you with your caseworker’s knowledge of the information you needed?
    satisfied_caseworke_knowledge: undefined | Option<'overall_satisfied_services'>
    // meaningful_access/satisfied_caseworke_knowledge_explain [text] Please explain
    satisfied_caseworke_knowledge_explain: string | undefined
    // safety/service_meet_expectations [select_one] Did the service meet your expectations?
    service_meet_expectations: undefined | Option<'comfortable_staff_members'>
    // safety/service_meet_expectations_explain [text] Please explain
    service_meet_expectations_explain: string | undefined
    // safety/comfortable_talking_caseworker [select_one] Did you feel comfortable talking to the caseworker?
    comfortable_talking_caseworker: undefined | Option<'comfortable_staff_members'>
    // safety/comfortable_talking_caseworker_explain [text] Please explain
    comfortable_talking_caseworker_explain: string | undefined
    // safety/caseworker_supported_decisions [select_one] Did you feel the caseworker supported your decisions?
    caseworker_supported_decisions: undefined | Option<'comfortable_staff_members'>
    // safety/caseworker_supported_decisions_explain [text] Please explain
    caseworker_supported_decisions_explain: string | undefined
    // safety/pressured_time_caseworker [select_one] Did you feel pressured at any time by your caseworker?
    pressured_time_caseworker: undefined | Option<'comfortable_staff_members'>
    // safety/pressured_time_caseworker_yes [text] Please explain
    pressured_time_caseworker_yes: string | undefined
    // safety/views_case_management [select_one] Were your views taken into account by DRC about the case management support you received?
    views_case_management: undefined | Option<'comfortable_staff_members'>
    // safety/views_case_management_no [text] Please explain
    views_case_management_no: string | undefined
    // participation_empowerment/caseworker_communication_skills [select_one] How satisfied were you with your caseworker’s communication skills?
    caseworker_communication_skills: undefined | Option<'comfortable_staff_members'>
    // participation_empowerment/caseworker_communication_skills_explain [text] Please explain
    caseworker_communication_skills_explain: string | undefined
    // participation_empowerment/comfortable_staff_members [select_one] Did you feel welcomed by and comfortable with staff members during the provision of services?
    comfortable_staff_members: undefined | Option<'comfortable_staff_members'>
    // participation_empowerment/comfortable_staff_members_explain [text] Please explain
    comfortable_staff_members_explain: string | undefined
    // participation_empowerment/caseworker_attitude_towards [text] Was there any issue in your caseworker’s attitude towards you that you would like to share?
    caseworker_attitude_towards: string | undefined
    // participation_empowerment/services_most_helpful [text] Of the services you received, which one did you find most helpful?
    services_most_helpful: string | undefined
    // accountability/channel_suggestion_complaint [select_one] If you had a suggestion for or a problem with the case management support, do you think you could channel the suggestion or lodge a complaint?
    channel_suggestion_complaint: undefined | Option<'caseworker_agreed_contact'>
    // accountability/channel_suggestion_complaint_explain [text] Please explain
    channel_suggestion_complaint_explain: string | undefined
    // accountability/made_complaint_responded [select_one] If you have ever given feedback or made a complaint, was it responded to or followed up?
    made_complaint_responded: undefined | Option<'staff_treated_respect'>
    // accountability/made_complaint_responded_no [text] If no, would you mind telling me which are the issues / what happened?
    made_complaint_responded_no: string | undefined
    // accountability/explain_rights_beginning [select_one] Did the caseworker explain your rights at the beginning?
    explain_rights_beginning: undefined | Option<'caseworker_agreed_contact'>
    // accountability/caseworker_agreed_contact [select_one] Did the caseworker follow up with the services you agreed to contact?
    caseworker_agreed_contact: undefined | Option<'caseworker_agreed_contact'>
    // accountability/caseworker_agreed_contact_explain [text] Please explain
    caseworker_agreed_contact_explain: string | undefined
    // accountability/staff_treated_respect [select_one] Did you feel that the staff treated you with respect during the intervention?
    staff_treated_respect: undefined | Option<'staff_treated_respect'>
    // accountability/staff_treated_respect_no [text] If ‘no’, please, specify
    staff_treated_respect_no: string | undefined
    // overall_satisfaction/extent_problem_addressed [select_one] To what extent has your problem been addressed?
    extent_problem_addressed: undefined | Option<'extent_problem_addressed'>
    // overall_satisfaction/extent_problem_addressed_explain [text] Please explain
    extent_problem_addressed_explain: string | undefined
    // overall_satisfaction/ability_solve_problems [select_one] Please complete the sentence.Through my participation in case management services, my ability to solve this/other problems has…
    ability_solve_problems: undefined | Option<'ability_solve_problems'>
    // overall_satisfaction/ability_solve_problems_001 [text] Please explain
    ability_solve_problems_001: string | undefined
    // overall_satisfaction/overall_satisfied_services [select_one] Overall, how satisfied were you with the services that you received from DRC protection staff?
    overall_satisfied_services: undefined | Option<'overall_satisfied_services'>
    // overall_satisfaction/overall_satisfied_services_explain [text] Please explain
    overall_satisfied_services_explain: string | undefined
    // overall_satisfaction/comment [text] What improvements can we make to our services for other clients?
