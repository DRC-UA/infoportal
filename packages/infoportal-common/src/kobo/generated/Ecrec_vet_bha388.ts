export namespace Ecrec_vet_bha388 {
  ...
  export interface T {
    ...
    // registration_questions/soft_skill_training [select_one] Частина грантової підтримки для учасників, які будуть відібрані для отримання гранту на навчання, включає проходження обов’язкового короткострокового тренінгу з розвитку соціально-емоційних навичок, метою якого є підтримка учасників та надання практичних навичок для працевлаштування. Чи підтверджуєте Ви готовність пройти зазначений тренінг?
    soft_skill_training: undefined | Option<'household_pregnant_that_breastfeeding_val'>
  ...
  export const options = {
    ...
    difficulty_usual_language: {
      no_difficulty: `Ні, труднощі відсутні`,
      some: `Так, є деякі труднощі`,
      lot: `Так, багато труднощів`,
      cannot_all: `Взагалі не можу(-е) робити`,
    },
    oblast: {
