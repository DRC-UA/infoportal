export namespace Protection_ipaTracker {
  export type Option<T extends keyof typeof options> = keyof (typeof options)[T]
  // Form id: amVgfKxFVjdJuNokQdNVzD
  export interface T {
    start: string
    end: string
    ...
    // introduction/staff_code [select_one] Staff code
    ...
    // introduction/assessment_date [date] Assessment date
    assessment_date: Date | undefined
    // introduction/case_status [select_one] Case Status
    case_status: undefined | Option<'case_status'>
    // case_information/name [text] Name
    name: string | undefined
    // case_information/gender [select_one] Gender
    gender: undefined | Option<'gender'>
    // case_information/date_birth [date] Date of birth
    date_birth: Date | undefined
    // case_information/ph_number [integer] Phone number
    ph_number: number | undefined
    // case_information/nationality [select_one] Nationality
    nationality: undefined | Option<'nationality'>
    // case_information/nationality_other [text] If other, specify
    nationality_other: string | undefined
    // case_information/status [select_one] Status
    status: undefined | Option<'status'>
    // case_information/specific_need [select_multiple] Specific need
    specific_need: undefined | Option<'specific_need'>[]
    // case_information/specific_need_other [text] If other specific need, please specify
    specific_need_other: string | undefined
    // case_information/oblast [select_one] Oblast
    oblast: undefined | Option<'oblast'>
    // case_information/raion [select_one] Raion
    ...
    type_need_other: string | undefined
    // ipa_assessment/risk_level [select_one] Risk Level
    risk_level: undefined | Option<'risk_level'>
    // ipa_assessment/budget_amount_assistance [integer] Budget amount of assistance (UAH)
    budget_amount_assistance: number | undefined
    // ipa_assessment/assistance_delivery_date [date] Assistance delivery date
    assistance_delivery_date: Date | undefined
    // ipa_assessment/followup_date [date] Follow-up Date
    followup_date: Date | undefined
    // ipa_assessment/followup_result [select_one] Follow-up Result
    followup_result: undefined | Option<'followup_result'>
    // ipa_assessment/additional_actions [text] Additional actions taken (if applicable)
    additional_actions: string | undefined
    // pdm/pdm_consent [select_one] PDM Consent
    pdm_consent: undefined | Option<'pdm_consent'>
    // pdm/pdm_date [select_one] PDM Conducted
    pdm_date: undefined | Option<'pdm_date'>
    // pdm/comments [text] Comments
  ...
  export const map = (_: Record<keyof T, any>): T =>
    ({
      ..._,
      assessment_date: _.assessment_date ? new Date(_.assessment_date) : undefined,
      ...
      followup_date: _.followup_date ? new Date(_.followup_date) : undefined,
    }) as T
}
