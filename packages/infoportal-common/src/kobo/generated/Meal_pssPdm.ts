export namespace Meal_pssPdm {
  ...
  export interface T {
    ...
    // gi/gidoo [text] Other (specify)
    gidoo: string | undefined
    ...
    // ques_bey_echo/satisfied_activities_provided [select_one] Are you satisfied with the activities provided?
    ...
    // ques_bey_echo/well_informed_service [select_one] Did you feel well informed about the PSS service available?
    ...
    // ques_bey_echo/know_people_needing_pss [select_one] Do you know of people needing PSS who were excluded from this activity provided?
    know_people_needing_pss: undefined | Option<'report_misconduct_employees'>
    // ques_bey_echo/know_people_needing_pss_yes [text] If ‘Mostly yes, Not really/not at all’, feel free to comment:
    know_people_needing_pss_yes: string | undefined
    // ques_bey_echo/know_where_address_suggestions [select_one] Do you know how and where you could address your suggestions, comments or complaints related to the work of the Danish Refugee Council, if any?
