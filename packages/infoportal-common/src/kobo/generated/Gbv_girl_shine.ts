export namespace Gbv_girl_shine {
  ...
  export interface T {
    ...
    date: Date | undefined
    // general_information/topic [select_one] Topic
    ...
    // general_information/oblast [select_one] Select oblast
    oblast: undefined | Option<'oblast'>
    // general_information/raion [select_one] Select raion
    raion: undefined | Option<'raion'>
    // general_information/hromada [select_one] Select hromada
    hromada: undefined | Option<'hromada'>
    // general_information/settlement [select_one_from_file] Specify settlement
    settlement: string
    // general_information/location [text] Location
    ...
    // women_rise_feedback_questions/safe_times_traveling [select_one] 1. Did you feel safe at all times traveling to and from the Women Rise session and while participating?
    safe_times_traveling: undefined | Option<'know_women_support'>
    // women_rise_feedback_questions/safe_times_traveling_no [text] 1.1 If no, what could have been done by the organization to make you feel safer?
    safe_times_traveling_no: string | undefined
    // women_rise_feedback_questions/staff_treated_respect [select_one] 2. Did you feel that the facilitators or staff treated you with respect during the sessions?
    staff_treated_respect: undefined | Option<'know_women_support'>
    // women_rise_feedback_questions/time_felt_disrespected [text] 3. If at any time you felt disrespected, could you tell us when or where this occurred and why?
    time_felt_disrespected: string | undefined
    // women_rise_feedback_questions/satisfied_women_rise [select_one] 4. Are you satisfied with the Women Rise program?
    satisfied_women_rise: undefined | Option<'know_women_support'>
    // women_rise_feedback_questions/satisfied_women_rise_no [text] 4.1 If no, would you mind telling us why?
    satisfied_women_rise_no: string | undefined
    // women_rise_feedback_questions/suggestion_women_rise [select_one] 5.If you had a suggestion or a problem with Women Rise programme, did you feel you could provide feedback or lodge a complaint?
    suggestion_women_rise: undefined | Option<'know_women_support'>
    // women_rise_feedback_questions/suggestions_complaints_responded [select_one] 6. To your knowledge, have suggestions or complaints been responded to or followed up?
    suggestions_complaints_responded: undefined | Option<'know_women_support'>
    // women_rise_feedback_questions/suggestions_complaints_responded_no [text] 6.1 If not, which issues were not addressed?
    suggestions_complaints_responded_no: string | undefined
    // women_rise_feedback_questions/enjoy_part_women_rise [select_one] 7. Did you enjoy taking part in the Women Rise sessions?
    enjoy_part_women_rise: undefined | Option<'enjoy_part_women_rise'>
    // women_rise_feedback_questions/enjoy_part_women_rise_details [text] 7.1 Option for comments:
    enjoy_part_women_rise_details: string | undefined
    // women_rise_feedback_questions/know_women_support [select_one] 8. Do you know where a women or girl could go to for support  if they experienced violence?
    know_women_support: undefined | Option<'know_women_support'>
    // women_rise_feedback_questions/wr_session_most [text] 9. What Women Rise session have you liked the most?
    wr_session_most: string | undefined
    // women_rise_feedback_questions/wr_ideas_future [text] 10. Do you have any suggestions or ideas on future activities?
    wr_ideas_future: string | undefined
  }
