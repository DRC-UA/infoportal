export namespace Ecrec_vet2_dmfa {
  export type Option<T extends keyof typeof options> = keyof (typeof options)[T]
  // Form id: ag34YtGDQiW5FstyAxzy5P
  export interface T {
    start: string
    end: string
    // age_Hhoh [calculate] Вік голови домогосподарства
    age_Hhoh: string
    // note_hello [note] Данська рада у справах біженців (DRC) розпочинає грантову програму, спрямовану на фінансування професійного навчання. Мета цієї програми - надати можливість перекваліфікації та підвищення кваліфікації для покращення можливостей працевлаштування людей, які постраждали від війни.    **Процес подання заявки** - Скористайтеся можливістю якнайповніше висловити свою мотивацію до участі в курсі професійного навчання. Окресліть свої перспективи працевлаштування після завершення курсу, надайте інформацію про вашу сімейну ситуацію та сформулюйте, чому ви вважаєте, що саме ви повинні отримати цей грант. Ваша детальна заявка дозволить нам краще зрозуміти ваші прагнення та прийняти обґрунтоване рішення. Наразі ми маємо обмежену кількість місць на програмі, і посилання на реєстрацію може бути закрите, якщо буде досягнуто максимальної кількості місць. Будь ласка, зверніть увагу, що DRC прагне надавати допомогу найбільш вразливим верствам населення та тим, хто не може самостійно профінансувати навчання на курсах професійної підготовки. Висловлення вашої зацікавленості не означає, що ви автоматично будете прийняті до програми.  - Кандидати будуть відібрані на основі їхніх індивідуальних потреб та вразливостей, мотивації, навичок та перспектив забезпечення довгострокового працевлаштування після завершення навчання. Після того, як ви подасте заявку, команда DRC розгляне її і, в разі схвалення, зв'яжеться з вами, щоб запросити на співбесіду. Після відбору учасники будуть проінформовані про наступні кроки.  - Відібрані кандидати отримають фінансову підтримку на обрану ними навчальну програму.  - Учасники програми зобов'язані подати фінансовий звіт з детальним описом витрат грантових коштів.   **Критерії відбору** Ви можете взяти участь у програмі, якщо ви є безробітним (безробітною) або маєте неповну зайнятість (працюєте на роботі з низьким рівнем оплати, зайняті у неформальному секторі або застрягли на роботі з обмеженими перспективами кар'єрного зростання або взагалі без них), а також ви повинні продемонструвати зацікавленість і мотивацію до навчання. Існує також можливість підвищення кваліфікації у вашій поточній сфері зайнятості або експертизи, якщо ви надасте належне обґрунтування та якщо ви маєте високий рівень вразливості.   **Заповнення аплікаційної форми** Будь ласка, заповніть форму нижче, якщо ви вважаєте, що відповідаєте критеріям і зацікавлені в проходженні курсу. Форма містить запитання, які допоможуть нам дізнатися про ваш досвід та мотивацію до навчання. Важливо! Реєстрація через цю форму не означає, що ви будете автоматично відібрані, Наразі ми маємо обмежену кількість місць в програмі, і посилання на реєстрацію може бути закрите, якщо буде досягнуто максимальної кількості місць. Процес відбору буде прозорим і конкурентним, з використанням критеріїв прийнятності, які зосереджуються на вашому рівні вразливості та мотивації до участі в програмі, а також на відповідності обраного вами курсу попиту на ринку праці.   **DRC високо цінує будь-який зворотній зв'язок, пов'язаний з нашими програмами. Якщо у вас виникли запитання чи побажання, будь ласка, зв'яжіться з нами електронною поштою UKR-feedback@drc.ngo; або за телефоном: 0 800 33 95 18 (понеділок-п'ятниця, з 9:00 до 17:00)**
    note_hello: string
