    ...
    return PromiseRetry((retry, number) => {
      return sdk.v2.updateData({
        ...
        data: KoboSdkv1.parseBody({
          'background/donor_mpca': fnSwitch(answer.donor_mpca!, donorMapping, () => undefined),
          'background/donor_nfi': fnSwitch(answer.donor_nfi!, donorMapping, () => undefined),
          'background/donor_esk': fnSwitch(answer.donor_esk!, donorMapping, () => undefined),
          'background/donor_cfr': fnSwitch(answer.donor_cfr!, donorMapping, () => undefined),
          'background/donor_cfe': fnSwitch(answer.donor_cfe!, donorMapping, () => undefined),
          'background/donor_iwk': fnSwitch(answer.donor_iwk!, donorMapping, () => undefined),
          'background/donor_ihk': fnSwitch(answer.donor_ihk!, donorMapping, () => undefined),
          'background/donor_cfu': fnSwitch(answer.donor_cfu!, donorMapping, () => undefined),
