      ...
      <Div responsive>
        ...
        <Div column>
          ...
          <Lazy deps={[filteredAndPickedData]} fn={() => {
            ...
            const sumPlannedReachedPwd = filteredAndPickedSgas.sum(_ => add(_.Number_of_beneficiaries_PwD_reached_001))
            ...
            const breakdown: ChartData = {
              boy: makeChartData({value: filteredAndPickedSgas.sum(_ => add(_.group_eq2ox56_row_column)), base: sumPlanned, label: m.boy}),
              girl: makeChartData({value: filteredAndPickedSgas.sum(_ => add(_.group_eq2ox56_row_column_1)), base: sumPlanned, label: m.girl}),
              male: makeChartData({value: filteredAndPickedSgas.sum(_ => add(_.group_eq2ox56_row_1_column)), base: sumPlanned, label: m.male}),
              female: makeChartData({value: filteredAndPickedSgas.sum(_ => add(_.group_eq2ox56_row_1_column_1)), base: sumPlanned, label: m.female}),
              elderlyMale: makeChartData({value: filteredAndPickedSgas.sum(_ => add(_.group_eq2ox56_row_2_column)), base: sumPlanned, label: m.elderlyMale}),
