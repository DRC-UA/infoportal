export namespace Pseah_training_tracker {
export type Option<T extends keyof typeof options> = keyof (typeof options)[T]
  ...
  date: Date | undefined,
	  // begin_group_qS00qeNhn/faciliator_name_1 [text] Training faciliator name and position
  faciliator_name_1: string | undefined,
	  // begin_group_qS00qeNhn/faciliator_name_2 [text] Training faciliator name and position
