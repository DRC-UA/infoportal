...
export const map = (_: Record<keyof T, any>): T => ({
	...
	estimated_transportations_costs: _.estimated_transportations_costs ? +_.estimated_transportations_costs : undefined,
